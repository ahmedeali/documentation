...
.. Note::
   ...
   Conformance)` set up on the :abbr:`DNS (Domain Name System)` will improve deliverability. For more
   information see :doc:`email_domain`.
...
.. example::
   ...
   system parameters (`mail.default.from` and `mail.catchall.domain`). This is the
   default\\notifications configuration in Odoo. `“Admin” <dmin@example.com>` => `“Admin”
